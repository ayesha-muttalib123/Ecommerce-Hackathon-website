   ...
   <SectionHeader
      ...
      <div className="max-w-6xl mx-auto p-4 grid grid-cols-2 gap-8 mt-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Image width={1000} height={100} src="/product3.png" alt="Bag" className="w-full h-full rounded" />
          <div className="grid grid-rows-3 gap-4">
            <Image height={150} width={150} src="/product1.png" alt="Small 1" className="rounded" />
            <Image  height={150} width={150} src="/product2.png" alt="Small 2" className="rounded" />
            <Image  height={150} width={150} src="/product4.png" alt="Small 3" className="rounded" />
          </div>
        </div>
